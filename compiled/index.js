...
var path_1 = __importDefault(__nccwpck_require__(17));
var fs_1 = __importDefault(__nccwpck_require__(147));
...
var main = function () {
    ...
    if (includeRegistry) {
        ...
        var registryLine = "@".concat(org, ":registry=https://").concat(registry, "\n");
        addLine(fullPath, registryLine);
    }
    if (includeAuth) {
        core.info('Both registry and token are found. Will add auth line.');
        var authLine = "//".concat(registry, "/:_authToken=").concat(token, "\n");
